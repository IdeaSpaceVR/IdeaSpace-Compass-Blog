...
<a-entity
		...
		@if ($post_counter > 0)
		<a-entity
				id="navigation-arrow-up-{{ $blog_post['post-title']['#content-id'] }}"
				class="navigation-arrow-up collidable"
				isvr-navigation-up="cid: {{ $blog_post['post-title']['#content-id'] }}"
		...
		<a-entity
				id="navigation-arrow-down-{{ $blog_post['post-title']['#content-id'] }}"
				class="navigation-arrow-down collidable"
				isvr-navigation-down="cid: {{ $blog_post['post-title']['#content-id'] }}"
				geometry="primitive: plane; width: 2; height: 2"
				position="1.15 0 -0.001" 
